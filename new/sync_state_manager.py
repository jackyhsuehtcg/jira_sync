...
class SyncStateManager:
    ...
    def is_cold_start(self, table_id: str) -> bool:
        ...
        try:
            ...
            stats = log_manager.get_processing_stats(table_id)
    ...
    def prepare_cold_start(self, table_id: str, existing_lark_records: List[Dict[str, Any]], 
        ...
        try:
            ...
            for record in existing_lark_records:
                ...
                if ticket_field:
                    ticket_to_record_map[ticket_field] = record_id
                    valid_records += 1
    ...
    def filter_issues_for_processing(self, table_id: str, 
        ...
        try:
            ...
            filtered_issues = log_manager.filter_issues_by_timestamp(jira_issues, table_id)
    ...
    def determine_sync_operations(self, table_id: str, 
        ...
        try:
            ...
            for issue in filtered_issues:
                ...
                # 查詢是否已有 Lark 記錄 ID
                lark_record_id = log_manager.get_lark_record_id(issue_key, table_id)
        ...
        try:
            ...
            for result in sync_results:
                if result.get('success', False):
                    ...
                    processing_result = f"error: {result.get('error', 'unknown')}"
                    error_count += 1
                
                processing_results.append({
                    'issue_key': result['issue_key'],
                    'jira_updated_time': result.get('jira_updated_time', 0),
                    'processing_result': processing_result,
                    'lark_record_id': result.get('lark_record_id'),
                    'table_id': table_id
                })
